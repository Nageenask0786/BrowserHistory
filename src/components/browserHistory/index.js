...
class History extends Component {
  ...
  deleteHistoryItems = id => {
    ...
    const filterHistoryItems = historyDetailsList.filter(each => each.id !== id)

    this.setState({historyDetailsList: filterHistoryItems})
  }

  render() {
    const {historyDetailsList, searchInput} = this.state
